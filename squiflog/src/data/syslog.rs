...
impl<'a> Message<'a> {
    ...
    pub fn from_rfc5424_bytes(s: &'a [u8]) -> Result<Self, Error> {
        ...
        Ok(Message {
            priority,
            timestamp: to_str(timestamp)?.map(|ts| Cow::Borrowed(ts)),
...
mod tests {
    ...
    fn parse_rfc5424_syslog_specs_example_1() {
        ...
        let expected = Message {
            ...
            timestamp: Some(Borrowed("2003-10-11T22:14:15.003Z")),
    ...
    fn parse_rfc5424_syslog_specs_example_2() {
        ...
        let expected = Message {
            ...
            timestamp: Some(Borrowed("2003-08-24T05:14:15.000003-07:00")),
